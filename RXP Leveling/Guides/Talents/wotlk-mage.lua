...
local talents = assert(_G.RXPGuides and _G.RXPGuides.talents,
                       "RXPGuides talent registry is unavailable")

talents.RegisterGuide([[
#name AoE 10-80
#minLevel 10
#maxLevel 80
...
talents.RegisterBuild("Arcane 10-80", [[
1,1,2,3;1,1,1,2;1,2,3,5;1,3,4,1;1,3,2,3;1,3,1,1;1,4,3,3;1,4,4,2;1,5,2,1;1,5,4,4;
1,6,2,3;1,6,3,2;1,7,2,1;1,7,1,3;1,5,4,1;1,8,2,2;1,8,3,3;1,9,3,5;1,10,2,3;1,10,3,2;
1,11,2,1;1,8,3,2;1,4,4,1;1,3,3,3;3,1,3,3;3,1,1,2;3,2,3,3;3,2,1,2;3,3,2,1;2,1,2,3
]])

talents.RegisterBuild("Fire 10-80", [[
2,1,3,5;2,2,1,5;2,3,3,1;2,3,4,2;2,1,1,2;2,4,1,3;2,4,4,2;2,5,3,1;2,5,2,3;2,4,4,1;
2,6,3,5;2,7,2,1;2,7,1,3;2,3,2,1;2,8,3,3;2,3,2,2;2,9,2,1;2,9,1,2;2,9,3,2;2,10,2,5;
2,11,2,1;1,1,1,2;1,1,2,3;1,2,3,5;1,3,2,3;1,3,3,2;1,4,4,3;1,4,3,2
]])
